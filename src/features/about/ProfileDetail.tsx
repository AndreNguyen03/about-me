...
function ProfileDetail() {
	...
	return (
		<div ref={ref} className='h-fit w-full rounded-lg px-4 py-2 shadow-xl md:w-1/2'>
			{isVisible && (
				<>
					<p className='text-xl font-bold'>Hello There!</p>
					<p className='py-4 text-sm'>
						I am a student of Software Engineering at the University of Information Technology (UIT) with a
						strong passion for web and technology development. I enjoy learning new things and always strive
						to improve my skills in programming, particularly in frontend and backend development.
					</p>
					...
					<div className='flex gap-2 py-2'>
						<Button
							...
							onClick={() => {
								const pdfUrl = 'NAnh_CV.pdf'

								const link = document.createElement('a')
								link.href = pdfUrl
								link.download = 'NguyenNguyenNgocAnh_SoftwareEngineer.pdf'
